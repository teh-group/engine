...
Don't worry, you have **☕ Teh**. It's a JavaScript alternative<sup>[1](#fn1)</sup>, based on ES3, back when writing scripts, not bloated apps for html pages was exciting. Teh is aimed for simplicity and ease of use for the common person. Teh is not compatible with JS by design, that means most of the JS libraries, frameworks and scripts will break, unless ported as Teh packages.
